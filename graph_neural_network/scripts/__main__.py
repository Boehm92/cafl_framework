...
_parser.add_argument('--train_val_partition',
                     dest='train_val_partition', default=2000, type=int,
...
_parser.add_argument('--max_epoch', dest='max_epoch', default=2, type=int,
...
_parser.add_argument('--network_model', dest='network_model', default=AgnNetwork,
                     help='GcNetwork, DgcnNetwork, SageGnNetwork, FeaStNetwork, GATNetwork, GATV2Network, ChebNetwork,'
                          'ArmaNetwork, AgnNetwork')
_parser.add_argument('--network_model_id', dest='network_model_id', default="AgnNetwork", type=str,
                     help='GcNetwork, DgcnNetwork, SageGnNetwork, FeaStNetwork, GATNetwork, GATV2Network, ChebNetwork,'
                          'ArmaNetwork, AgnNetwork')
